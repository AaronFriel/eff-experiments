...
{-# OPTIONS_GHC -Wno-missing-signatures -Wno-name-shadowing -Wno-unused-do-bind #-}

-- The framework of extensible effects

module Data.Iota.Tagged.Eff1 where

import Control.Monad
import Control.Applicative
import Data.Iota.Tagged.OpenUnion51
-- import Data.FastTCQueue
import Data.Iota.Tagged.FTCQueue1
...
run :: Eff '[] w -> w
run (Val x) = x
run (E _ _) = error "unreachable, Union '[] impossible"
